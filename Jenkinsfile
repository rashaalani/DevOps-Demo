...
pipeline {
 ...
 stage('Execute Maven') {
		...
		rtMaven.run pom: '/var/lib/jenkins/workspace/Javapipeline/examples/feed-combiner-java8-webapp/pom.xml', goals: 'clean install -Dmaven.test.skip=true', buildInfo: buildInfo
			}
		}
